        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(userName)){
                    Toast.makeText(LoginAcitivity.this,"请输入用户名",Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    Toast.makeText(LoginAcitivity.this,"输入的用户名和密码不一致",Toast.LENGTH_SHORT).show();
                    return;
                }else {
                    Toast.makeText(LoginAcitivity.this,"请输入用户名",Toast.LENGTH_SHORT).show();
                }
