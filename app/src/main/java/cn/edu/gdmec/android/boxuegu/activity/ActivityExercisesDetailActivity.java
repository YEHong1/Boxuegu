...
/**
 * Created by Curtain_Liang on 2018/4/21.
 */
...
public class ActivityExercisesDetailActivity extends AppCompatActivity {
    ...
    private void initData() {
        try {
            ...
            ebl = AnalysisUtils.getExercisesInfo(is);
    ...
    private void init() {
        ...
        adapter = new ExercisesDetailListItemAdapter(ActivityExercisesDetailActivity.this, ebl, new ExercisesDetailListItemAdapter.OnSelectListener() {
            ...
            public void onSelectA(int position, ImageView iv_a, ImageView iv_b, ImageView iv_c, ImageView iv_d) {
                ...
                tv_dibu.setText("第" + (position + 1) + "道题完成，共5题");
                count++;
                Intent data = new Intent();
                data.putExtra("id", id);
                data.putExtra("count", count);
